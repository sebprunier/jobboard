...
public class JsonJobSerializerTest {
    ...
    public void testMarshall() {
        ...
        String json = serializer.marshall(new Job("1", "Job 1", "This is Job number one", new Date(1356537739208L)));
    ...
    public void testMarshallAll() {
        ...
        String json = serializer.marshallAll(Arrays.asList(new Job[] {
                new Job("1", "Job 1", "This is Job number one", new Date(1356537739208L)),
                new Job("2", "Job 2", "This is Job number two", new Date(1356537739208L)) }));
